...
# plt.show()
plt.savefig(os.path.join(output_path, "loan_histograms.png"))
...
for feature in outlier_columns:
    ...
    plt.legend()
    # plt.show()
    plot_filename = f"loan_scatter_{feature}.png"  # Use feature name in the file
...
# plt.show()
plt.savefig(os.path.join(output_path, "loan_outliers_gender.png"))
...
# plt.show()
plt.savefig(os.path.join(output_path, "loan_outliers_married.png"))
...
# plt.show()
plt.savefig(os.path.join(output_path, "loan_outliers_dependents.png"))
...
# plt.show()
plt.savefig(os.path.join(output_path, "loan_outliers_education.png"))
...
# plt.show()
plt.savefig(os.path.join(output_path, "loan_outliers_self_employed.png"))
...
# plt.show()
plt.savefig(os.path.join(output_path, "loan_outliers_application.png"))
...
# plt.show()
plt.savefig(os.path.join(output_path, "loan_outliers_coapplicant.png"))
...
# plt.show()
plt.savefig(os.path.join(output_path, "loan_removed_outliers_gender.png"))
...
# plt.show()
plt.savefig(os.path.join(output_path, "loan_removed_outliers_married.png"))
...
# plt.show()
plt.savefig(os.path.join(output_path, "loan_removed_outliers_dependents.png"))
...
# plt.show()
plt.savefig(os.path.join(output_path, "loan_removed_outliers_education.png"))
...
# plt.show()
plt.savefig(os.path.join(output_path, "loan_removed_outliers_self_employed.png"))
...
# plt.show()
plt.savefig(os.path.join(output_path, "loan_removed_outliers_application.png"))
...
# plt.show()
plt.savefig(os.path.join(output_path, "loan_removed_outliers_coapplicant.png"))
...
# plt.show()
plt.savefig(os.path.join(output_path, "loan_metrics.png"))
...
plt.tight_layout()
# plt.show()
plt.savefig(os.path.join(output_path, "loan_metrix.png"))
