...
file_path = "output_first_10000.csv"
...
sns.pairplot(data, hue='IUCR', plot_kws={'alpha': 0.5})
plt.suptitle("Pairplot of Features with IUCR Class Labels (Including Outliers)", y=1.02)
# plt.show()
plt.savefig(os.path.join(output_path, "chicago_outliers_IUCR.png"))

sns.pairplot(data, hue='Primary Type', plot_kws={'alpha': 0.5})
plt.suptitle("Pairplot of Features with Primary Type Class Labels (Including Outliers)", y=1.02)
# plt.show()
plt.savefig(os.path.join(output_path, "chicago_outliers_Primary.png"))
...
sns.pairplot(cleaned_data, hue='IUCR', plot_kws={'alpha': 0.5})
plt.suptitle("Pairplot of Features with IUCR Class Labels (After Removing Outliers)", y=1.02)
# plt.show()
plt.savefig(os.path.join(output_path, "chicago_removed_outliers_IUCR.png"))

sns.pairplot(cleaned_data, hue='Primary Type', plot_kws={'alpha': 0.5})
plt.suptitle("Pairplot of Features with Primary Type Class Labels (After Removing Outliers)", y=1.02)
# plt.show()
plt.savefig(os.path.join(output_path, "chicago_removed_outliers_Primary.png"))
